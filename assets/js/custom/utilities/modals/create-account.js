              ...
              fields: {
                ...
                call_number: {
                  validators: {
                    ...
                    digits: { message: "Numéro doit contenir que des chiffres" },
                    stringLength: {
                      min: 9,
                      max: 9,
                      message: "Numéro doit contenir 9 chiffres",
                    },
                  },
                },
                otp_number: {
                  validators: { 
                    notEmpty: { message: "Code OTP obligatoire" },
                    digits: { message: "OTP doit contenir que des chiffres" },
                    stringLength: {
                        min: 6,
                        max: 6,
                        message: "OTP doit contenir 6 chiffres",
                    },
                },
              },
                account_plan: {
